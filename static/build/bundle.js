...
/***/ function(module, exports, __webpack_require__) {
	...
	/* REACT HOT LOADER */ if (false) { (function () { var ReactHotAPI = require("/Users/katerynaporshnieva/Projects/github-users-viewer/node_modules/react-hot-api/modules/index.js"), RootInstanceProvider = require("/Users/katerynaporshnieva/Projects/github-users-viewer/node_modules/react-hot-loader/RootInstanceProvider.js"), ReactMount = require("react/lib/ReactMount"), React = require("react"); module.makeHot = module.hot.data ? module.hot.data.makeHot : ReactHotAPI(function () { return RootInstanceProvider.getRootInstances(ReactMount); }, React); })(); } try { (function () {
	...
	/* REACT HOT LOADER */ }).call(this); } finally { if (false) { (function () { var foundReactClasses = module.hot.data && module.hot.data.foundReactClasses || false; if (module.exports && module.makeHot) { var makeExportsHot = require("/Users/katerynaporshnieva/Projects/github-users-viewer/node_modules/react-hot-loader/makeExportsHot.js"); if (makeExportsHot(module, require("react"))) { foundReactClasses = true; } var shouldAcceptModule = true && foundReactClasses; if (shouldAcceptModule) { module.hot.accept(function (err) { if (err) { console.error("Cannot not apply hot update to " + "index.js" + ": " + err.message); } }); } } module.hot.dispose(function (data) { data.makeHot = module.makeHot; data.foundReactClasses = foundReactClasses; }); })(); } }
...
/***/ function(module, exports, __webpack_require__) {
	...
	function configure(initialState) {
	    ...
	    var createStoreWithMiddleware = _redux.applyMiddleware.apply(undefined, middlewares)(create);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var DEFAULT_STATE = { items: [], selectedLanguage: '', loadingPercent: 0, error: null };
	...
	function users() {
	    ...
	    switch (action.type) {
	        case _users.LOAD_USERS_LIST_REQUEST:
	            {
	        ...
	        case _users.LOAD_USERS_LIST_SUCCESS:
	            {
	                var items = action.items.map(function (user) {
	                    return {
	                        login: user.login,
	                        isLoading: true
	                    };
	        ...
	        case _users.LOAD_USERS_LIST_FAIL:
	            {
	                return (0, _extends3.default)({}, state, {
	                    error: (0, _utils.formatError)(action.error)
	                });
	            }

	        case _users.LOAD_USER_PROFILE_SUCCESS:
	            {
	                var _items = state.items.map(function (item) {
	                    return item.login === action.login ? (0, _extends3.default)({}, (0, _utils.formatUserProfile)(action.profileData), {
	                        isLoading: false
	                    }) : item;
	                });

	                var loadingPercent = state.loadingPercent + 1 / _items.length * 100;
...
/***/ function(module, exports, __webpack_require__) {
	...
	exports.LOAD_USER_PROFILE_SUCCESS = exports.LOAD_USERS_LIST_FAIL = exports.LOAD_USERS_LIST_SUCCESS = exports.LOAD_USERS_LIST_REQUEST = undefined;
	exports.loadPopularUsersByLanguage = loadPopularUsersByLanguage;
	...
	var LOAD_USERS_LIST_REQUEST = exports.LOAD_USERS_LIST_REQUEST = 'LOAD_USERS_LIST_REQUEST';
	var LOAD_USERS_LIST_SUCCESS = exports.LOAD_USERS_LIST_SUCCESS = 'LOAD_USERS_LIST_SUCCESS';
	var LOAD_USERS_LIST_FAIL = exports.LOAD_USERS_LIST_FAIL = 'LOAD_USERS_LIST_FAIL';
	var LOAD_USER_PROFILE_SUCCESS = exports.LOAD_USER_PROFILE_SUCCESS = 'LOAD_USER_PROFILE_SUCCESS';

	function loadPopularUsersByLanguage(language) {
	    return function (dispatch) {
	        dispatch({
	        ...
	        return _api2.default.searchUsersByLanguage(language).then(function (_ref) {
	            var searchData = _ref.data;
	            ...
	            searchData.items.forEach(function (item) {
	                _api2.default.showUserProfile(item.login).then(function (_ref2) {
	                    var profileData = _ref2.data;
...
/***/ function(module, exports, __webpack_require__) {
	...
	exports.searchUsersByLanguage = searchUsersByLanguage;
	...
	function searchUsersByLanguage(language) {
	    var params = {
	        'q': 'language:' + language,
	        'per_page': _config2.default.numberOfProfilesToDisplay,
	        'access_token': _config2.default.githubApiToken,
	        'sort': 'followers',
	        'order': 'desc'
	    };

	    return _axios2.default.get(API_PREFIX + '/search/users', { params: params });
	}
	...
	function showUserProfile(login) {
	    ...
	    return _axios2.default.get(API_PREFIX + '/users/' + login, { params: params });
	}

	exports.default = {
	    searchUsersByLanguage: searchUsersByLanguage,
...
/***/ function(module, exports, __webpack_require__) {
	...
	exports.default = window.APP_CONFIG;
...
/***/ function(module, exports, __webpack_require__) {
	...
	var LANGUAGES = ['javascript', 'java', 'python', 'css', 'php', 'c++', 'c#', 'c', 'shell', 'objective-c', 'go', 'perl'];

	var DEFAULT_SELECTED_LANGUAGE = LANGUAGES[0];
	...
	var AppContainer = function (_Component) {
	    ...
	    (0, _createClass3.default)(AppContainer, [{
	        ...
	        value: function componentWillMount() {
	            var loadPopularUsersByLanguage = this.props.actions.loadPopularUsersByLanguage;
	        ...
	        value: function render() {
	            ...
	            var selectedLanguage = _props.selectedLanguage;
	            var loadingPercent = _props.loadingPercent;
	...
	function mapDispatchToProps(dispatch) {
	    return {
	        actions: (0, _redux.bindActionCreators)(UsersActions, dispatch)
	    };
	}
...
/***/ function(module, exports, __webpack_require__) {
	...
	module.exports = __webpack_require__(263)('iterator');
...
/***/ function(module, exports, __webpack_require__) {
	...
	__webpack_require__(186)(IteratorPrototype, __webpack_require__(263)('iterator'), function(){ return this; });
...
/***/ function(module, exports, __webpack_require__) {
	...
	var global        = __webpack_require__(182)
	  , hide          = __webpack_require__(186)
	  , Iterators     = __webpack_require__(257)
	  , TO_STRING_TAG = __webpack_require__(263)('toStringTag');
...
/***/ function(module, exports, __webpack_require__) {
	...
	var global         = __webpack_require__(182)
	  ...
	  , toPrimitive    = __webpack_require__(194)
	  , createDesc     = __webpack_require__(195)
	  , _create        = __webpack_require__(259)
	...
	module.exports = {
	  set: Object.setPrototypeOf || ('__proto__' in {} ? // eslint-disable-line
	    function(test, buggy, set){
	      try {
	        set = __webpack_require__(184)(Function.call, __webpack_require__(277).f(Object.prototype, '__proto__').set, 2);
	        set(test, []);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _reactProgress = __webpack_require__(288);

	var _reactProgress2 = _interopRequireDefault(_reactProgress);

	var _LanguageSelect = __webpack_require__(289);

	var _LanguageSelect2 = _interopRequireDefault(_LanguageSelect);

	var _UserTile = __webpack_require__(294);
	...
	var App = function (_Component) {
	    ...
	    (0, _createClass3.default)(App, [{
	        ...
	        value: function render() {
	            ...
	            var loadingPercent = _props.loadingPercent;
	            var error = _props.error;
	            var onLanguageChange = _props.onLanguageChange;
	            ...
	            return _react2.default.createElement(
	                ...
	                _react2.default.createElement(
	                    'div',
	                    { className: _App2.default.content },
	                    _react2.default.createElement(_reactProgress2.default, { percent: loadingPercent, speed: 0 }),
	                    _react2.default.createElement(_LanguageSelect2.default, {
	                        selectedLanguage: selectedLanguage,
	                        languages: languages,
	...
	App.propTypes = {
	    users: _react.PropTypes.arrayOf(_react.PropTypes.object),
	    selectedLanguage: _react.PropTypes.string,
	    languages: _react.PropTypes.arrayOf(_react.PropTypes.string),
	    loadingPercent: _react.PropTypes.number,
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _LanguageSelect = __webpack_require__(290);

	var _LanguageSelect2 = _interopRequireDefault(_LanguageSelect);

	function _interopRequireDefault(obj) { return obj && obj.__esModule ? obj : { default: obj }; }

	var LanguageSelect = function (_Component) {
	    (0, _inherits3.default)(LanguageSelect, _Component);

	    function LanguageSelect() {
	        (0, _classCallCheck3.default)(this, LanguageSelect);
	        return (0, _possibleConstructorReturn3.default)(this, (0, _getPrototypeOf2.default)(LanguageSelect).apply(this, arguments));
	    }
	    ...
	    (0, _createClass3.default)(LanguageSelect, [{
	        ...
	        value: function render() {
	            ...
	            return _react2.default.createElement(
	                'div',
	                { className: _LanguageSelect2.default.root },
	                _react2.default.createElement(
	                    'select',
	                    { value: selectedLanguage, onChange: this.handleChange.bind(this) },
	...
	/* REACT HOT LOADER */ }).call(this); } finally { if (false) { (function () { var foundReactClasses = module.hot.data && module.hot.data.foundReactClasses || false; if (module.exports && module.makeHot) { var makeExportsHot = require("/Users/katerynaporshnieva/Projects/github-users-viewer/node_modules/react-hot-loader/makeExportsHot.js"); if (makeExportsHot(module, require("react"))) { foundReactClasses = true; } var shouldAcceptModule = true && foundReactClasses; if (shouldAcceptModule) { module.hot.accept(function (err) { if (err) { console.error("Cannot not apply hot update to " + "LanguageSelect.jsx" + ": " + err.message); } }); } } module.hot.dispose(function (data) { data.makeHot = module.makeHot; data.foundReactClasses = foundReactClasses; }); })(); } }
...
/***/ function(module, exports, __webpack_require__) {
	...
	if(false) {
		...
		if(!content.locals) {
			module.hot.accept("!!./../../node_modules/css-loader/index.js?modules&sourceMap&importLoaders=1&localIdentName=[name]__[local]___[hash:base64:5]!./../../node_modules/postcss-loader/index.js!./LanguageSelect.css", function() {
				var newContent = require("!!./../../node_modules/css-loader/index.js?modules&sourceMap&importLoaders=1&localIdentName=[name]__[local]___[hash:base64:5]!./../../node_modules/postcss-loader/index.js!./LanguageSelect.css");
...
/***/ function(module, exports, __webpack_require__) {
	...
	// module
	exports.push([module.id, ".LanguageSelect__root___3XcOA {\n    padding: 16px;\n    width: 100%;\n    display: -webkit-box;\n    display: -webkit-flex;\n    display: -ms-flexbox;\n    display: flex;\n    -webkit-box-orient: vertical;\n    -webkit-box-direction: normal;\n    -webkit-flex-direction: column;\n        -ms-flex-direction: column;\n            flex-direction: column;\n    -webkit-box-align: center;\n    -webkit-align-items: center;\n        -ms-flex-align: center;\n            align-items: center;\n}\n\n.LanguageSelect__title___dZckw {\n    font-size: 18px;\n}", "", {"version":3,"sources":["/./components/LanguageSelect.css"],"names":[],"mappings":"AAAA;IACI,cAAc;IACd,YAAY;IACZ,qBAAc;IAAd,sBAAc;IAAd,qBAAc;IAAd,cAAc;IACd,6BAAuB;IAAvB,8BAAuB;IAAvB,+BAAuB;QAAvB,2BAAuB;YAAvB,uBAAuB;IACvB,0BAAoB;IAApB,4BAAoB;QAApB,uBAAoB;YAApB,oBAAoB;CACvB;;AAED;IACI,gBAAgB;CACnB","file":"LanguageSelect.css","sourcesContent":[".root {\n    padding: 16px;\n    width: 100%;\n    display: flex;\n    flex-direction: column;\n    align-items: center;\n}\n\n.title {\n    font-size: 18px;\n}"],"sourceRoot":"webpack://"}]);

	// exports
	exports.locals = {
		"root": "LanguageSelect__root___3XcOA",
		"title": "LanguageSelect__title___dZckw"
	};
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _UserTile = __webpack_require__(295);
	...
	var UserTile = function (_Component) {
	    (0, _inherits3.default)(UserTile, _Component);

	    function UserTile() {
	        (0, _classCallCheck3.default)(this, UserTile);
	        return (0, _possibleConstructorReturn3.default)(this, (0, _getPrototypeOf2.default)(UserTile).apply(this, arguments));
	    }

	    (0, _createClass3.default)(UserTile, [{
	        key: 'render',
	        value: function render() {
	            var _props = this.props;
	            ...
	            var numberOfFollowers = _props.numberOfFollowers;


	            if (isLoading) {
	                return _react2.default.createElement('div', { className: _UserTile2.default.root });
	            }

	            return _react2.default.createElement(
	                'a',
	                { href: link, target: '_blank', className: _UserTile2.default.root },
	                _react2.default.createElement('img', { className: _UserTile2.default.avatar, src: avatar }),
	                _react2.default.createElement(
	                    'div',
	                    { className: _UserTile2.default.info },
	                    _react2.default.createElement(
	                        'div',
	                        { className: _UserTile2.default.name },
	                        ' ',
	                        name,
	                        ' '
	                    ),
	                    _react2.default.createElement(
	                        'div',
	                        { className: _UserTile2.default.followers },
	                        ' ',
	                        numberOfFollowers,
	                        ' followers '
	                    )
	...
	UserTile.propTypes = {
	    ...
	    numberOfFollowers: _react.PropTypes.number,
	    isLoading: _react.PropTypes.bool
	};
	exports.default = UserTile;

	/* REACT HOT LOADER */ }).call(this); } finally { if (false) { (function () { var foundReactClasses = module.hot.data && module.hot.data.foundReactClasses || false; if (module.exports && module.makeHot) { var makeExportsHot = require("/Users/katerynaporshnieva/Projects/github-users-viewer/node_modules/react-hot-loader/makeExportsHot.js"); if (makeExportsHot(module, require("react"))) { foundReactClasses = true; } var shouldAcceptModule = true && foundReactClasses; if (shouldAcceptModule) { module.hot.accept(function (err) { if (err) { console.error("Cannot not apply hot update to " + "UserTile.jsx" + ": " + err.message); } }); } } module.hot.dispose(function (data) { data.makeHot = module.makeHot; data.foundReactClasses = foundReactClasses; }); })(); } }
...
/***/ function(module, exports, __webpack_require__) {
	...
	if(false) {
		// When the styles change, update the <style> tags
		if(!content.locals) {
			module.hot.accept("!!./../../node_modules/css-loader/index.js?modules&sourceMap&importLoaders=1&localIdentName=[name]__[local]___[hash:base64:5]!./../../node_modules/postcss-loader/index.js!./UserTile.css", function() {
				var newContent = require("!!./../../node_modules/css-loader/index.js?modules&sourceMap&importLoaders=1&localIdentName=[name]__[local]___[hash:base64:5]!./../../node_modules/postcss-loader/index.js!./UserTile.css");
				if(typeof newContent === 'string') newContent = [[module.id, newContent, '']];
				update(newContent);
			});
		}
...
/***/ function(module, exports, __webpack_require__) {
	...
	// module
	exports.push([module.id, ".UserTile__root___2Mz-c {\n    width: 200px;\n    height: 200px;\n    position: relative;\n}\n\n.UserTile__avatar___1sZNa {\n    max-width: 100%;\n    max-height: 100%;\n}\n\n.UserTile__title___3oa3x {\n    font-size: 18px;\n}\n\n.UserTile__info___1DqXM {\n    position: absolute;\n    width: 100%;\n    padding: 8px;\n    bottom: 0;\n    left: 0;\n    background-color: rgba(0,0,0,0.6);\n    color: #fff;\n}\n\n.UserTile__name___Uvls1 {\n    font-weight: bold;\n}", "", {"version":3,"sources":["/./components/UserTile.css"],"names":[],"mappings":"AAAA;IACI,aAAa;IACb,cAAc;IACd,mBAAmB;CACtB;;AAED;IACI,gBAAgB;IAChB,iBAAiB;CACpB;;AAED;IACI,gBAAgB;CACnB;;AAED;IACI,mBAAmB;IACnB,YAAY;IACZ,aAAa;IACb,UAAU;IACV,QAAQ;IACR,kCAAkC;IAClC,YAAY;CACf;;AAED;IACI,kBAAkB;CACrB","file":"UserTile.css","sourcesContent":[".root {\n    width: 200px;\n    height: 200px;\n    position: relative;\n}\n\n.avatar {\n    max-width: 100%;\n    max-height: 100%;\n}\n\n.title {\n    font-size: 18px;\n}\n\n.info {\n    position: absolute;\n    width: 100%;\n    padding: 8px;\n    bottom: 0;\n    left: 0;\n    background-color: rgba(0,0,0,0.6);\n    color: #fff;\n}\n\n.name {\n    font-weight: bold;\n}"],"sourceRoot":"webpack://"}]);

	// exports
	exports.locals = {
		"root": "UserTile__root___2Mz-c",
		"avatar": "UserTile__avatar___1sZNa",
		"title": "UserTile__title___3oa3x",
		"info": "UserTile__info___1DqXM",
		"name": "UserTile__name___Uvls1"
	};
...
/***/ function(module, exports, __webpack_require__) {
	...
	// module
	exports.push([module.id, ".App__root___1yDxW {\n    background-color: #eaeaea;\n    width: 100vw;\n    min-height: 100vh;\n}\n\n.App__content___6h2sv {\n    display: -webkit-box;\n    display: -webkit-flex;\n    display: -ms-flexbox;\n    display: flex;\n    -webkit-box-orient: vertical;\n    -webkit-box-direction: normal;\n    -webkit-flex-direction: column;\n        -ms-flex-direction: column;\n            flex-direction: column;\n    -webkit-box-align: center;\n    -webkit-align-items: center;\n        -ms-flex-align: center;\n            align-items: center;\n    max-width: 900px;\n    width: 100%;\n    padding-bottom: 16px;\n    padding-top: 16px;\n    margin: 0 auto;\n}\n\n.App__list___3Icve {\n    display: -webkit-box;\n    display: -webkit-flex;\n    display: -ms-flexbox;\n    display: flex;\n    -webkit-flex-wrap: wrap;\n        -ms-flex-wrap: wrap;\n            flex-wrap: wrap;\n    -webkit-box-pack: center;\n    -webkit-justify-content: center;\n        -ms-flex-pack: center;\n            justify-content: center;\n}", "", {"version":3,"sources":["/./components/App.css"],"names":[],"mappings":"AAAA;IACI,0BAA0B;IAC1B,aAAa;IACb,kBAAkB;CACrB;;AAED;IACI,qBAAc;IAAd,sBAAc;IAAd,qBAAc;IAAd,cAAc;IACd,6BAAuB;IAAvB,8BAAuB;IAAvB,+BAAuB;QAAvB,2BAAuB;YAAvB,uBAAuB;IACvB,0BAAoB;IAApB,4BAAoB;QAApB,uBAAoB;YAApB,oBAAoB;IACpB,iBAAiB;IACjB,YAAY;IACZ,qBAAqB;IACrB,kBAAkB;IAClB,eAAe;CAClB;;AAED;IACI,qBAAc;IAAd,sBAAc;IAAd,qBAAc;IAAd,cAAc;IACd,wBAAgB;QAAhB,oBAAgB;YAAhB,gBAAgB;IAChB,yBAAwB;IAAxB,gCAAwB;QAAxB,sBAAwB;YAAxB,wBAAwB;CAC3B","file":"App.css","sourcesContent":[".root {\n    background-color: #eaeaea;\n    width: 100vw;\n    min-height: 100vh;\n}\n\n.content {\n    display: flex;\n    flex-direction: column;\n    align-items: center;\n    max-width: 900px;\n    width: 100%;\n    padding-bottom: 16px;\n    padding-top: 16px;\n    margin: 0 auto;\n}\n\n.list {\n    display: flex;\n    flex-wrap: wrap;\n    justify-content: center;\n}"],"sourceRoot":"webpack://"}]);

	// exports
	exports.locals = {
		"root": "App__root___1yDxW",
		"content": "App__content___6h2sv",
		"list": "App__list___3Icve"
	};
